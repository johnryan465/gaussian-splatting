...
def render(viewpoint_camera: Camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        cov_offset=viewpoint_camera.cov_offset,
        prefiltered=False,
        debug=pipe.debug
    )
...
def render_eval(viewpoint_camera: Camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    """
    Render the scene. 
